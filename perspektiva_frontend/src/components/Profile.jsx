...
export default function Profile({ closeProfile = () => void 0 }) {
  ...
  return (
    <div className="text-black">
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-4xl w-full p-8 transition-all duration-300 animate-fade-in relative">
        <div
          className=" absolute top-0 right-2 text-black"
          ...
          userme.favourites?.map((item) => (
            <div class="flex flex-col md:flex-row">
              <div class="md:w-1/3 text-center mb-8 md:mb-0">
                ...
                <button class="mt-4 bg-indigo-800 text-white px-4 py-2 rounded-lg hover:bg-blue-900 transition-colors duration-300">
                  Edit Profile
                </button>
              </div>
